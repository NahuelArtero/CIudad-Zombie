...
function modificarSprite(arreglo) {
  for (i = 0; i < arreglo.length; i++) {
    // Cuanto tocan el borde izquierdo
    if (arreglo[i].x == i + 1) {
      arreglo[i].sprite = "imagenes/zombieDer.png";
    }

    // Cuanto tocan el borde derecho
    if (arreglo[i].x == 961) {
      arreglo[i].sprite = "imagenes/zombieIzq.png";
    }
  }
}
